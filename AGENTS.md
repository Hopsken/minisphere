...
- For local Accounts browser tests, open `https://localhost:5173/__dev/log-me-in/dev@example.com?returnTo=/` in the browser session used for tests. A `curl` request does not sign that browser in.
